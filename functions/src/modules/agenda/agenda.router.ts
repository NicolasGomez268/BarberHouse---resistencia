...
agendaRouter.patch('/fijos/:id/pausar', (req, res) => agendaController.pausarTurnoFijo(req, res))
agendaRouter.patch('/fijos/:id/reanudar', (req, res) => agendaController.reanudarTurnoFijo(req, res))
