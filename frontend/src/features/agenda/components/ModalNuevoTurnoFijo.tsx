...
export function ModalNuevoTurnoFijo({ isOpen, onClose, onGuardar, barberos, servicios }: Props) {
  ...
  const [fechasAgendadas, setFechasAgendadas] = useState<string[]>([])
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    onGuardar({
      ...
      diaSemana: getScheduleDayIndex(fechasOrdenadas[0]),
      hora: form.hora,
      ...
      >
        <div className="border-b border-[#242424] px-6 py-5">
          ...
          <p className="mt-1 text-sm text-[#a0a0a0]">
            El turno se repetira automaticamente segun la frecuencia elegida
          </p>
        </div>
