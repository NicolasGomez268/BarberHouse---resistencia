...
export function ServiciosPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pb-10 text-white">
        ...
        {servicios.map((servicio) => (
          ...
          >
            ...
            <div className="mt-5 grid grid-cols-[1fr_54px] gap-2">
              <button
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#2563eb] px-4 py-3 font-bold text-white transition hover:bg-[#1d4ed8]"
          ...
          >
            ...
            <div className="mt-7 space-y-5">
              <label className="block">
                ...
                <input
                  className="mt-2 w-full rounded-lg border border-[#475569] bg-[#1f2937] px-4 py-3 text-white outline-none placeholder:text-[#94a3b8] focus:border-[#f5c518]"
              ...
              <label className="block">
                ...
                <textarea
                  className="mt-2 min-h-[92px] w-full resize-none rounded-lg border border-[#475569] bg-[#1f2937] px-4 py-3 text-white outline-none placeholder:text-[#94a3b8] focus:border-[#f5c518]"
                  onChange={(event) =>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3">
              ...
              <button
                className="rounded-lg bg-[#e5c04f] px-4 py-3 font-bold text-[#111827] transition hover:bg-[#f5c518]"
                type="submit"
              >
      ...
      {deletingServicio ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
          <section className="w-full max-w-[448px] rounded-lg border border-[#475569] bg-[#111827] p-6 text-center text-white shadow-2xl">
